...
class CoreTests(unittest.TestCase):
    ...
    def test_renewables_keeps_forecast_processes_separate(self):
        ...
        self.assertEqual(data['kpi']['forecast_basis'], 'day-ahead')
        self.assertEqual(data['kpi']['res_error_mw'], 17.0)
        self.assertEqual(data['kpi']['res_error_id_mw'], 8.0)
    ...
    def test_public_api_does_not_expose_force_parameter_or_cache_clear_ui(self):
        ...
        for src in (html, js):
            ...
            self.assertNotIn('/api/cache/clear', src)
